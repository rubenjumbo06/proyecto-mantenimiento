...
export default function DocumentosContent({ setSidebarOpen }: DocumentosContentProps) {
    ...
    <>
      ...
      <header className="bg-slate-700 text-white px-6 py-4 flex items-center justify-between">
        <div className="flex items-center space-x-4">
          ...
          <h1 className="text-xl font-semibold">Ordenes de mantenimiento pendientes de planificacion y programacion</h1>
        </div>
      </header>
      ...
      <main className="flex-1 overflow-auto p-6">
        ...
        <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 mb-6">
          <Button className="bg-blue-600 text-white hover:bg-blue-700">Nueva Solicitud</Button>
              ...
              {maintenanceOrders.map((order) => (
                ...
                >
                  <div className="flex justify-between items-start">
                    <div>
                      <div className="font-medium text-gray-900 mb-1">{order.id} {order.description}</div>
