...
interface PlanificacionContentProps {
  setSidebarOpen: (open: boolean) => void;
}

// Componente principal para el contenido de Órdenes de Mantenimiento
export default function PlanificacionContent({ setSidebarOpen }: PlanificacionContentProps) {
  ...
  const estadoOptions = [
    ...
    { value: "espera-re", label: "En espera de Recursos" },
    { value: "espera-pro", label: "En espera de Programacion" },
  ...
  // Lógica para filtrar las planificacion de mantenimiento
    ...
    <>
      ...
      <header className="bg-slate-700 text-white px-6 py-4 flex items-center justify-between">
        <div className="flex items-center space-x-4">
          ...
          <h1 className="text-xl font-semibold">Ordenes de mantenimiento pendientes de planificación y programación</h1>
        </div>
